...
export const getFooterData_index = (content: ITranslations): AppFooterData[] => [
  {
    ...
    links: [
      ...
      { label: content.footer.links[0].links[1], link: '/' },
  ...
  },
  {
    ...
    links: [
      { label: content.footer.links[1].links[0], link: 'https://github.com/fosslytech' },
      { label: content.footer.links[1].links[1], link: 'https://github.com/fosslytech' },
      { label: content.footer.links[1].links[2], link: 'https://github.com/fosslytech' },
    ],
  },
  {
    ...
    links: [
      ...
      { label: content.footer.links[2].links[1], link: 'https://github.com/fosslytech' },
    ],
  },
];
